		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mentoringfinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoringfinal-display": {
								"semanticObject": "mentoringfinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoringfinal",
									"url": sap.ui.require.toUrl("mentoringfinal")
								}
							}
						}
					}
